...
public abstract class RemoteFile {
	...
	public static RemoteFile fromFile(File localFile) {
		return LocalFile.createRoot(localFile, null);
	}
	 ...
	 * using {@link DistributedPlatform#mountFile(RemoteFile)}. Then the path to song.mp3 will be
	 * music/song.mp3.
	 * </p>
	 *
	 ...
	 * file was directly mounted using one of {@link DistributedPlatform}'s mount methods. Else
	 ...
	 * {@link DistributedPlatform}. Therefore this method also returns a valid date if the
	 ...
	 * <p>
	 * Files should not be modified while they are being mounted by a
	 * {@link DistributedPlatform}. Therefore this method also returns a valid size if the
	 * hosting peer is not available.
	 * </p>
	 *
	...
	/**
	 * Copies this {@link RemoteFile} to a isLocal file. This method blocks until
	...
	/**
	 * If this file is stored on the isLocal systemcontrol, this method returns the
	 * associated {@link File}. To test if a file is isLocal, use
	 * {@link #isLocal()}.
	 *
	 * @return the associated File if available
	 * @throws NoSuchElementException
	 *             if this file is stored on a remote systemcontrol
	 */
	public abstract File localFile() throws NoSuchElementException;

	/**
	 * A file is isLocal, it its associated peer is the isLocal peer.
	 *
